...
public class TestBSTRecursive {
	...
	public void testNextOf() {
		...
		assertEquals(8,t.nextOf(r, 6));
		assertEquals(8,t.nextOf(r, 7));
		assertEquals(9,t.nextOf(r, 8));
		assertEquals(12,t.nextOf(r, 9));
		assertEquals(12,t.nextOf(r, 10));
		assertEquals(12,t.nextOf(r, 11));
		assertEquals(12,t.nextOf(r, 12));
		assertEquals(13,t.nextOf(r, 13));
